...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2018 at 01:51 AM
...
(4773, 'COURSE_C', 'COURSE_C', 'COURSE'),
(4774, 'COURSE_R', 'COURSE_R', 'COURSE'),
(4775, 'COURSE_U', 'COURSE_U', 'COURSE'),
(4776, 'COURSE_D', 'COURSE_D', 'COURSE'),
(4777, 'COURSE_TYPE_C', 'COURSE_TYPE_C', 'COURSE TYPE'),
(4778, 'COURSE_TYPE_R', 'COURSE_TYPE_R', 'COURSE TYPE'),
(4779, 'COURSE_TYPE_U', 'COURSE_TYPE_U', 'COURSE TYPE'),
(4780, 'COURSE_TYPE_D', 'COURSE_TYPE_D', 'COURSE TYPE'),
(4781, 'COURSE_SESSIONAL_TYPE_C', 'COURSE_SESSIONAL_TYPE_C', 'COURSE SESSIONAL TYPE'),
(4782, 'COURSE_SESSIONAL_TYPE_R', 'COURSE_SESSIONAL_TYPE_R', 'COURSE SESSIONAL TYPE'),
(4783, 'COURSE_SESSIONAL_TYPE_U', 'COURSE_SESSIONAL_TYPE_U', 'COURSE SESSIONAL TYPE'),
(4784, 'COURSE_SESSIONAL_TYPE_D', 'COURSE_SESSIONAL_TYPE_D', 'COURSE SESSIONAL TYPE'),
(4785, 'CLUB_C', 'CLUB_C', 'CLUB'),
(4786, 'CLUB_R', 'CLUB_R', 'CLUB'),
(4787, 'CLUB_U', 'CLUB_U', 'CLUB'),
(4788, 'CLUB_D', 'CLUB_D', 'CLUB'),
(4789, 'DISCUSSION_C', 'DISCUSSION_C', 'DISCUSSION'),
(4790, 'DISCUSSION_R', 'DISCUSSION_R', 'DISCUSSION'),
(4791, 'DISCUSSION_U', 'DISCUSSION_U', 'DISCUSSION'),
(4792, 'DISCUSSION_D', 'DISCUSSION_D', 'DISCUSSION'),
(4793, 'DISCUSSION_CAT_C', 'DISCUSSION_CAT_C', 'DISCUSSION CATEGORY'),
(4794, 'DISCUSSION_CAT_R', 'DISCUSSION_CAT_R', 'DISCUSSION CATEGORY'),
(4795, 'DISCUSSION_CAT_U', 'DISCUSSION_CAT_U', 'DISCUSSION CATEGORY'),
(4796, 'DISCUSSION_CAT_D', 'DISCUSSION_CAT_D', 'DISCUSSION CATEGORY'),
(4797, 'DISCUSSION_COMMENT_C', 'DISCUSSION_COMMENT_C', 'DISCUSSION COMMENT'),
(4798, 'DISCUSSION_COMMENT_R', 'DISCUSSION_COMMENT_R', 'DISCUSSION COMMENT'),
(4799, 'DISCUSSION_COMMENT_U', 'DISCUSSION_COMMENT_U', 'DISCUSSION COMMENT'),
(4800, 'DISCUSSION_COMMENT_D', 'DISCUSSION_COMMENT_D', 'DISCUSSION COMMENT'),
(4801, 'DISCIPLINE_C', 'DISCIPLINE_C', 'DISCIPLINE'),
(4802, 'DISCIPLINE_R', 'DISCIPLINE_R', 'DISCIPLINE'),
(4803, 'DISCIPLINE_U', 'DISCIPLINE_U', 'DISCIPLINE'),
(4804, 'DISCIPLINE_D', 'DISCIPLINE_D', 'DISCIPLINE'),
(4805, 'FILE_C', 'FILE_C', 'FILE'),
(4806, 'FILE_R', 'FILE_R', 'FILE'),
(4807, 'FILE_U', 'FILE_U', 'FILE'),
(4808, 'FILE_D', 'FILE_D', 'FILE'),
(4809, 'PERMISSION_C', 'PERMISSION_C', 'PERMISSION'),
(4810, 'PERMISSION_R', 'PERMISSION_R', 'PERMISSION'),
(4811, 'PERMISSION_U', 'PERMISSION_U', 'PERMISSION'),
(4812, 'PERMISSION_D', 'PERMISSION_D', 'PERMISSION'),
(4813, 'POSITION_C', 'POSITION_C', 'POSITION'),
(4814, 'POSITION_R', 'POSITION_R', 'POSITION'),
(4815, 'POSITION_U', 'POSITION_U', 'POSITION'),
(4816, 'POSITION_D', 'POSITION_D', 'POSITION'),
(4817, 'PROJECT_C', 'PROJECT_C', 'PROJECT'),
(4818, 'PROJECT_R', 'PROJECT_R', 'PROJECT'),
(4819, 'PROJECT_U', 'PROJECT_U', 'PROJECT'),
(4820, 'PROJECT_D', 'PROJECT_D', 'PROJECT'),
(4821, 'QUESTION_C', 'QUESTION_C', 'QUESTION'),
(4822, 'QUESTION_R', 'QUESTION_R', 'QUESTION'),
(4823, 'QUESTION_U', 'QUESTION_U', 'QUESTION'),
(4824, 'QUESTION_D', 'QUESTION_D', 'QUESTION'),
(4825, 'REGISTRATION_C', 'REGISTRATION_C', 'REGISTRATION'),
(4826, 'REGISTRATION_R', 'REGISTRATION_R', 'REGISTRATION'),
(4827, 'REGISTRATION_U', 'REGISTRATION_U', 'REGISTRATION'),
(4828, 'REGISTRATION_D', 'REGISTRATION_D', 'REGISTRATION'),
(4829, 'RESULT_C', 'RESULT_C', 'RESULT'),
(4830, 'RESULT_R', 'RESULT_R', 'RESULT'),
(4831, 'RESULT_U', 'RESULT_U', 'RESULT'),
(4832, 'RESULT_D', 'RESULT_D', 'RESULT'),
(4833, 'ATTENDANCE_C', 'ATTENDANCE_C', 'ATTENDANCE'),
(4834, 'ATTENDANCE_R', 'ATTENDANCE_R', 'ATTENDANCE'),
(4835, 'ATTENDANCE_U', 'ATTENDANCE_U', 'ATTENDANCE'),
(4836, 'ATTENDANCE_D', 'ATTENDANCE_D', 'ATTENDANCE'),
(4837, 'MARKS_SETUP_C', 'MARKS_SETUP_C', 'MARKS_SETUP'),
(4838, 'MARKS_SETUP_R', 'MARKS_SETUP_R', 'MARKS_SETUP'),
(4839, 'MARKS_SETUP_U', 'MARKS_SETUP_U', 'MARKS_SETUP'),
(4840, 'MARKS_SETUP_D', 'MARKS_SETUP_D', 'MARKS_SETUP'),
(4841, 'GRADE_SETUP_C', 'GRADE_SETUP_C', 'GRADE_SETUP'),
(4842, 'GRADE_SETUP_R', 'GRADE_SETUP_R', 'GRADE_SETUP'),
(4843, 'GRADE_SETUP_U', 'GRADE_SETUP_U', 'GRADE_SETUP'),
(4844, 'GRADE_SETUP_D', 'GRADE_SETUP_D', 'GRADE_SETUP'),
(4845, 'ROLE_C', 'ROLE_C', 'ROLE'),
(4846, 'ROLE_R', 'ROLE_R', 'ROLE'),
(4847, 'ROLE_U', 'ROLE_U', 'ROLE'),
(4848, 'ROLE_D', 'ROLE_D', 'ROLE'),
(4849, 'SCHOOL_C', 'SCHOOL_C', 'SCHOOL'),
(4850, 'SCHOOL_R', 'SCHOOL_R', 'SCHOOL'),
(4851, 'SCHOOL_U', 'SCHOOL_U', 'SCHOOL'),
(4852, 'SCHOOL_D', 'SCHOOL_D', 'SCHOOL'),
(4853, 'SESSION_C', 'SESSION_C', 'SESSION'),
(4854, 'SESSION_R', 'SESSION_R', 'SESSION'),
(4855, 'SESSION_U', 'SESSION_U', 'SESSION'),
(4856, 'SESSION_D', 'SESSION_D', 'SESSION'),
(4857, 'SURVEY_C', 'SURVEY_C', 'SURVEY'),
(4858, 'SURVEY_R', 'SURVEY_R', 'SURVEY'),
(4859, 'SURVEY_U', 'SURVEY_U', 'SURVEY'),
(4860, 'SURVEY_D', 'SURVEY_D', 'SURVEY'),
(4861, 'SURVEY_QUESTION_C', 'SURVEY_QUESTION_C', 'SURVEY QUESTION'),
(4862, 'SURVEY_QUESTION_R', 'SURVEY_QUESTION_R', 'SURVEY QUESTION'),
(4863, 'SURVEY_QUESTION_U', 'SURVEY_QUESTION_U', 'SURVEY QUESTION'),
(4864, 'SURVEY_QUESTION_D', 'SURVEY_QUESTION_D', 'SURVEY QUESTION'),
(4865, 'SURVEY_QUESTION_TYPE_C', 'SURVEY_QUESTION_TYPE_C', 'SURVEY QUESTION TYPE'),
(4866, 'SURVEY_QUESTION_TYPE_R', 'SURVEY_QUESTION_TYPE_R', 'SURVEY QUESTION TYPE'),
(4867, 'SURVEY_QUESTION_TYPE_U', 'SURVEY_QUESTION_TYPE_U', 'SURVEY QUESTION TYPE'),
(4868, 'SURVEY_QUESTION_TYPE_D', 'SURVEY_QUESTION_TYPE_D', 'SURVEY QUESTION TYPE'),
(4869, 'SURVEY_QUESTION_FILLUP_C', 'SURVEY_QUESTION_FILLUP_C', 'SURVEY QUESTION FILLUP'),
(4870, 'SURVEY_QUESTION_FILLUP_R', 'SURVEY_QUESTION_FILLUP_R', 'SURVEY QUESTION FILLUP'),
(4871, 'SURVEY_QUESTION_FILLUP_U', 'SURVEY_QUESTION_FILLUP_U', 'SURVEY QUESTION FILLUP'),
(4872, 'SURVEY_QUESTION_FILLUP_D', 'SURVEY_QUESTION_FILLUP_D', 'SURVEY QUESTION FILLUP'),
(4873, 'TERM_C', 'TERM_C', 'TERM'),
(4874, 'TERM_R', 'TERM_R', 'TERM'),
(4875, 'TERM_U', 'TERM_U', 'TERM'),
(4876, 'TERM_D', 'TERM_D', 'TERM'),
(4877, 'USER_C', 'USER_C', 'USER'),
(4878, 'USER_R', 'USER_R', 'USER'),
(4879, 'USER_U', 'USER_U', 'USER'),
(4880, 'USER_D', 'USER_D', 'USER'),
(4881, 'YEAR_C', 'YEAR_C', 'YEAR'),
(4882, 'YEAR_R', 'YEAR_R', 'YEAR'),
(4883, 'YEAR_U', 'YEAR_U', 'YEAR'),
(4884, 'YEAR_D', 'YEAR_D', 'YEAR'),
(4885, 'VIDEO_C', 'VIDEO_C', 'VIDEO'),
(4886, 'VIDEO_R', 'VIDEO_R', 'VIDEO'),
(4887, 'VIDEO_U', 'VIDEO_U', 'VIDEO'),
(4888, 'VIDEO_D', 'VIDEO_D', 'VIDEO'),
(4889, 'VIDEO_COMMENT_C', 'VIDEO_COMMENT_C', 'VIDEO COMMENT'),
(4890, 'VIDEO_COMMENT_R', 'VIDEO_COMMENT_R', 'VIDEO COMMENT'),
(4891, 'VIDEO_COMMENT_U', 'VIDEO_COMMENT_U', 'VIDEO COMMENT'),
(4892, 'VIDEO_COMMENT_D', 'VIDEO_COMMENT_D', 'VIDEO COMMENT'),
(4893, 'JOB_C', 'JOB_C', 'JOB'),
(4894, 'JOB_R', 'JOB_R', 'JOB'),
(4895, 'JOB_U', 'JOB_U', 'JOB'),
(4896, 'JOB_D', 'JOB_D', 'JOB'),
(4897, 'BUDGET', 'BUDGET_C', 'BUDGET'),
(4898, 'BUDGET_R', 'BUDGET_R', 'BUDGET'),
(4899, 'BUDGET_U', 'BUDGET_U', 'BUDGET'),
(4900, 'BUDGET_D', 'BUDGET_D', 'BUDGET');
...
(2222, 'student', 'BUDGET_R'),
(2223, 'student', 'CLUB_C'),
(2224, 'student', 'CLUB_R'),
(2225, 'student', 'CLUB_U'),
(2226, 'student', 'CLUB_D'),
(2227, 'student', 'COURSE_C'),
(2228, 'student', 'COURSE_R'),
(2229, 'student', 'COURSE_U'),
(2230, 'student', 'COURSE_D'),
(2231, 'student', 'DISCUSSION_C'),
(2232, 'student', 'DISCUSSION_R'),
(2233, 'student', 'DISCUSSION_U'),
(2234, 'student', 'DISCUSSION_D'),
(2235, 'student', 'DISCUSSION_COMMENT_C'),
(2236, 'student', 'DISCUSSION_COMMENT_R'),
(2237, 'student', 'DISCUSSION_COMMENT_U'),
(2238, 'student', 'DISCUSSION_COMMENT_D'),
(2239, 'student', 'JOB_R'),
(2240, 'student', 'PROJECT_C'),
(2241, 'student', 'PROJECT_R'),
(2242, 'student', 'PROJECT_U'),
(2243, 'student', 'PROJECT_D'),
(2244, 'student', 'QUESTION_C'),
(2245, 'student', 'QUESTION_R'),
(2246, 'student', 'QUESTION_U'),
(2247, 'student', 'QUESTION_D'),
(2248, 'student', 'REGISTRATION_R'),
(2249, 'student', 'RESULT_R'),
(2250, 'student', 'USER_R'),
(2251, 'student', 'VIDEO_C'),
(2252, 'student', 'VIDEO_R'),
(2253, 'student', 'VIDEO_U'),
(2254, 'student', 'VIDEO_D'),
(2255, 'teacher', 'BUDGET_R'),
(2256, 'teacher', 'COURSE_C'),
(2257, 'teacher', 'COURSE_R'),
(2258, 'teacher', 'COURSE_U'),
(2259, 'teacher', 'COURSE_D'),
(2260, 'teacher', 'DISCUSSION_C'),
(2261, 'teacher', 'DISCUSSION_R'),
(2262, 'teacher', 'DISCUSSION_U'),
(2263, 'teacher', 'DISCUSSION_D'),
(2264, 'teacher', 'DISCUSSION_CAT_C'),
(2265, 'teacher', 'DISCUSSION_CAT_R'),
(2266, 'teacher', 'DISCUSSION_CAT_U'),
(2267, 'teacher', 'DISCUSSION_CAT_D'),
(2268, 'teacher', 'DISCUSSION_COMMENT_C'),
(2269, 'teacher', 'DISCUSSION_COMMENT_R'),
(2270, 'teacher', 'DISCUSSION_COMMENT_U'),
(2271, 'teacher', 'DISCUSSION_COMMENT_D'),
(2272, 'teacher', 'FILE_C'),
(2273, 'teacher', 'FILE_R'),
(2274, 'teacher', 'FILE_U'),
(2275, 'teacher', 'FILE_D'),
(2276, 'teacher', 'PROJECT_C'),
(2277, 'teacher', 'PROJECT_R'),
(2278, 'teacher', 'PROJECT_U'),
(2279, 'teacher', 'PROJECT_D'),
(2280, 'teacher', 'QUESTION_C'),
(2281, 'teacher', 'QUESTION_R'),
(2282, 'teacher', 'QUESTION_U'),
(2283, 'teacher', 'QUESTION_D'),
(2284, 'teacher', 'REGISTRATION_C'),
(2285, 'teacher', 'REGISTRATION_R'),
(2286, 'teacher', 'REGISTRATION_U'),
(2287, 'teacher', 'REGISTRATION_D'),
(2288, 'teacher', 'RESULT_C'),
(2289, 'teacher', 'RESULT_R'),
(2290, 'teacher', 'RESULT_U'),
(2291, 'teacher', 'RESULT_D');
...
('mefahimrahman@gmail.com', '160215', 'mefahimrahman@gmail.com', '$2y$10$bDvNgJGWSGmFhPoiaBkVu.38lyOihOu3KbNSSJ.WFw04bZterzBgi', 'A. K. M.', 'Fahim', 'Rahman', '{FFDB1CB8-AF34-4381-8971-9784DCB516C5}', 'approved', NULL, NULL, NULL),
...
('uttamkumar0036@gmail.com', '160236', 'uttamkumar0036@gmail.com', '$2y$10$kfbGfj94RnHhKSALXz2zOu16hGv84k06Z07Lrx.sHEZBteo/9wDwa', 'Uttam', 'Kumar', 'Paul', '{FFDB1CB8-AF34-4381-8971-9784DCB516C5}', 'approved', NULL, NULL, NULL),
...
('mefahimrahman@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL),
...
('uttamkumar0036@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL),
...
(168, 'mefahimrahman@gmail.com', 'student'),
(171, 'uttamkumar0036@gmail.com', 'administrator'),
(172, 'aysha@gmail.com', 'teacher');
...
--
ALTER TABLE `budget_sector`
  MODIFY `budget_sector_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
--
-- AUTO_INCREMENT for table `budget_subsector`
--
ALTER TABLE `budget_subsector`
  MODIFY `budget_subsector_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
-- AUTO_INCREMENT for table `ums_permission`
--
ALTER TABLE `ums_permission`
  MODIFY `TableID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4901;
--
-- AUTO_INCREMENT for table `ums_role_permission`
--
ALTER TABLE `ums_role_permission`
  MODIFY `Row` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2292;
--
